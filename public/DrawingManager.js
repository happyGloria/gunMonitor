...
(function() {
    ...
    (function() {
         ...
         * @grammar obj.dispatchEvent(eventconfig, options)
         ...
         * @name baidu.event.on
         * @function
         * @grammar baidu.eventconfig.on(element, type, listener)
         ...
         * @name baidu.event.un
         * @function
         * @grammar baidu.eventconfig.un(element, type, listener)
         * @param {HTMLElement|string|window} element 目标元素或目标元素id
         * @param {string} type 事件类型
         ...
         * @function
         * @grammar baidu.eventconfig.preventDefault(eventconfig)
