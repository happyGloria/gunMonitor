<template>  
  <div id="statisticsOfAlarmTypes">
    <el-select class="selectRange" v-model="value" placeholder="请选择">
      <el-option v-for="item in options" :selected="item.value=='1'" :key="item.value" :label="item.label" :value="item.value"></el-option>
    </el-select>
